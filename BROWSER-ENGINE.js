...
if(process.argv.length != 9)
{
    ...
    console.log(`Usage: node BROWSER-ENGINE.js [URL] [TIME] [UA-FILE] [THREADS] [METHOD] [PROXY-FILE] [REFERER-FILE]`);
    process.exit(3162);
}
...
console.log(`Attack started on ${target} for ${time} seconds!`);
...
function BrowserEngine()
{
    ...
    console.log(`Attacking --> ${target} Proxy --> [${proxy}]`);
